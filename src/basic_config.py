...
colors1 = [color_sequence[i] for i in range(len(color_sequence)) if i % 2 == 0]
colors2 = [color_sequence[i] for i in range(len(color_sequence)) if i % 2 == 1]

color_sequence = []
color_sequence.extend(colors1)
color_sequence.extend(colors2)
